...
class ModelManager:
    ...
    def __init__(
        ...
        self.language_model = AsyncLLM(
            language_model_name, api_base, timeout=llm_timeout
        )
        self.vision_model = AsyncLLM(
            vision_model_name, api_base, timeout=llm_timeout
        )
        self.text_model = AsyncLLM(text_model_name, api_base, timeout=llm_timeout)
