...
PROMPT_MODULE_NAME = os.getenv("PRESENTAGENT_DEEPRESEARCH_PROMPT_MODULE", "prompt")
...
class MultiTurnReactAgent(FnCallAgent):
    ...
    def _rewrite_search_queries(self, queries, question: str) -> list[str]:
        ...
        expansions = [
            f"{base} explainer page",
            f"{base} official documentation",
            f"{base} paper",
            f"{base} video animation demo",
        ]
    ...
    def _rewrite_visit_goal(self, question: str) -> str:
        return VISIT_GOAL_TEMPLATE.format(question=question)
